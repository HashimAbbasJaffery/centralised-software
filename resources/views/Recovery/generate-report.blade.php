<x-layout.app>
    ...
    <style>
     ...
     background:red;
        ...
        .choices__item--selectable[data-value='honorary']:not(.choices__item--choice) {
            background: #4b77e8 !important;
            border: none;
        }
        ...
        <div style="display: flex; column-gap: 10px;">
            ...
            <div style="width: 33.33%;">
                <label class="block text-sm" style="margin-bottom: 20px;">
                    ...
                    <input v-model="start_date" type="date" data-message="member_field_message"
                    ...
                    <span class="member_field_message text-xs text-red-600 dark:text-red-400" style="display: none;">
                        Member's field is required </span>
                </label>
            </div>
            <div style="width: 33.33%;">
                <label class="block text-sm" style="margin-bottom: 20px;">
                    <span class="text-gray-700 dark:text-gray-400">End Date</span>
                    <input v-model="end_date" type="date" data-message="member_field_message"
                        class="step_1 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        placeholder="shahmir ahsanullah">
                    <span class="member_field_message text-xs text-red-600 dark:text-red-400" style="display: none;">
                        Member's field is required </span>
            ...
            <div style="width: 33.33%;">
                <label for="status">
                    ...
                    <select name="status[]" v-model="statuses" id="status" class="choices form-control label"
                        multiple>
                ...
                <div class="card-body p-0">
                    <div class="row my-3 date-print">
                        ...
                        <div class="col-sm-4">
                            <table class="" style="width:100%">
                                <tr>
                                    <td class="d-print text-center"><span>End Date: </span><span
                                            v-text="end_date"></span></td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-sm-4">
                            <table class="" style="width:100%">
                                <tr>
                                    <td class="d-print text-right"><span>Select Status: </span><span
                                            v-text="statuses.join(', ')"></span></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-2">
                            <table style="width:100%; height:20px;" class="mt-1">
                                <thead>
                                    <tr>
                                        <th style="width:100%; text-align:center; font-size:12px; font-weight:600;">
                                            Total recovery Amount</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr style="border:2px solid #000; position-relative; bottom:0px;">
                                        <td style="width:100%; text-align:center; font-weight:600; font-size:13px; padding:5px; height:40px;"
                                            id="total-payable" v-text="sum.toLocaleString()"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="col-sm-2">
                            <table style="width:100%; height:20px;" class="mt-1">
                                <thead>
                                    <tr>
                                        <th style="width:100%; text-align:center; font-size:12px; font-weight:600;"
                                            colspan="2">Total Installment paid</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr style="border:2px solid #000; position-relative; bottom:0px;">
                                        <td
                                            style="width:30%; text-align:center; font-weight:600; font-size:13px; border:2px solid #000; padding:5px; height:40px;">
                                        </td>
                                        <td
                                            style="width:70%; text-align:center; font-weight:600; font-size:13px; padding:5px;">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table-bordered table-sm my-3" style="width:100%; height:20px; border:none;">
                                <tr>
                                    <td style="width:20%; background:#bbd5d2; padding:3px;">
                                        ...
                                        <p style="font-size:11px; line-height: 10px; background:none;">Request for
                                            Payment</p>
                                    </td>
                                    <td style="width:20%; background:#fef000; padding:3px;">
                                        <h4 style="font-weight:600; font-size:12px; background:none;">Level 2</h4>
                                        <p style="font-size:11px; line-height: 10px; background:none;">Payment Reminder
                                            Letter</p>
                                    </td>
                                    ...
                                    <td style="width:20%; background:#a60411; padding:3px;">
                                        <h4 style="font-weight:600; font-size:12px; color:#fff; background:none;">Level
                                            4</h4>
                                        <p style="font-size:11px; line-height: 10px; background:none; color:#fff;">
                                    ...
                                    <td style="width:20%; background:#4b77e8; padding:3px;">
                                        <p style="font-size:12px; line-height: 10px; background:none; color:#fff;">
                                            Honorary</p>
                                    </td>
                                    <td
                                        style="width:20%; font-size:12px; background:#27241b; color:#fff; padding:3px; text-align:center;">
                                        Cleared</td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-sm-3">
                            <table style="width:100%;" class="my-4">
                                <tr style="border:2px solid #000; position-relative; bottom:0px;">
                                    <td
                                        style="width:50%; text-align:center; font-weight:600; font-size:13px; border:2px solid #000; padding:5px; height:40px;">
                                        Approved By</td>
                                    <td
                                        style="width:50%; text-align:center; font-weight:600; font-size:13px; padding:5px;height:40px;">
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <table class="table table-bordered table-sm">
                        ...
                        <tbody>
                            <tr style="font-size:13px;" v-for="(report, index) in reports" :key="report.id">
                                ...
                                <td v-if="(report?.recovery_phone_number?.length ?? 0) > 0"
                                    v-text="report.recovery_phone_number"></td>
                                <td v-else-if="report.phone_number?.replace('+', '').split(', ')[0]?.length ?? null > 0"
                                    v-text="report.phone_number?.replace('+', '').split(', ')[0]"></td>
                                <td v-else-if="report.phone_number?.replace('+', '').split(', ')[1]?.length ?? null > 0"
                                    v-text="report.phone_number?.replace('+', '').split(', ')[1]"></td>
                                <td v-else-if="report.alternate_ph_number.length > 0"
                                    v-text="report.alternate_ph_number.replace('+', '')"></td>
                                <td v-else>-</td>

                                <td v-if="report.alternate_ph_number?.replace('+', '')?.length ?? null > 0"
                                    v-text="report.alternate_ph_number?.replace('+', '')"></td>
                                <td v-else>-</td>

                                <td class="text-right pe-2 latest_payable"
                                    v-text="report.recovery[0]?.payable.toLocaleString() ?? 'no updated'"></td>

                                <td class="status">
                                    <input v-if="report.payment_status === 'level1'" class="form-control print-status"
                                        type="text" style="color: black; background-color: #bbd5d2;"
                                        value="Level 1" readonly>
                                    <input v-else-if="report.payment_status === 'level2'"
                                        class="form-control print-status" type="text"
                                        style="color: black; background-color: rgb(254, 240, 0);" value="Level 2"
                                        readonly>
                                    <input v-else-if="report.payment_status === 'level3'"
                                        class="form-control print-status" type="text"
                                        style="color: black; background-color: rgb(255, 156, 7);" value="Level 3"
                                        readonly>
                                    <input v-else-if="report.payment_status === 'level4'"
                                        class="form-control print-status" type="text"
                                        style="color: white; background-color: rgb(166, 4, 17);" value="Level 4"
                                        readonly>
                                    <input v-else-if="report.payment_status === 're-regularized'"
                                        class="form-control print-status" type="text"
                                        style="color: white; background-color: rgb(102, 20, 22);"
                                        value="Re-regularized" readonly>
                                    <input v-else-if="report.payment_status === 'honorary'"
                                        class="form-control print-status" type="text"
                                        style="color: white; background-color: #4b77e8;" value="Honorary" readonly>
                                    <input v-else-if="report.payment_status === 'cleared'"
                                        class="form-control print-status" type="text"
                                        style="color: white; background-color: rgb(39, 36, 27);" value="Cleared"
                                        readonly>
                                    <input v-else class="form-control print-status" type="text"
                                        style="color: black; background-color: #e9ecef;" value="Regular" readonly>
                                </td>
                                <td></td>
                            </tr>
                        </tbody>

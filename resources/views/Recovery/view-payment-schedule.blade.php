                ...
                <div class="container px-6 mx-auto grid mx-6" style="margin-top: 20px; border-radius: 10px; background: rgba(26, 28, 35, var(--bg-opacity);">
                    <table style="color: white;">
                        <tr>
                            ...
                            <td style="padding: 10px; color: rgb(158, 158, 158)">Form Fee: <span v-text="member.form_fee"></span></td>
                            <td style="padding: 10px; color: rgb(158, 158, 158)">Processing Fee: <span v-text="member.processing_fee"></span></td>
                        </tr>
                        <tr>
                            <td style="padding: 10px; color: rgb(158, 158, 158)">First Payment: <span v-text="member.first_payment"></span></td>
                            <td style="padding: 10px; color: rgb(158, 158, 158)">Total Installment: <span v-text="member.total_installment"></span></td>
                ...
                <div class="container grid" style="border-radius: 10px;">
                  ...
                  <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    <tr class="text-gray-700 dark:text-gray-400" v-for="(row, index) in rows" :key="row.id">
                        ...
                        <td style="padding-left: 15px; padding-bottom: 10px; padding-top: 10px;">
                            <input type="text" :value="sumAndSave(row.current_month_payable, parseInt(row.late_month_charges) + parseInt(due_amounts[index]), row.id, 'payable')" style="font-size: 10px;" readonly @change="console.log('test')" class="step_1 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                        </td>
                        <td style="padding-left: 15px; padding-bottom: 10px; padding-top: 10px;">

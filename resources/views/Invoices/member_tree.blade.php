            ...
            <div style="position: relative">
                ...
                <table style="width: 450.72pt; border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        @if($member->card_type)
                            <td style="font-size: 6.5pt !important; border: 0.5px solid black; padding-left: 5pt; padding-top: 5pt; padding-bottom: 5pt;"><span style="font-weight: 500;">Card Type: </span>{{ $member->card_type }}</td>
                        @else
                            <td style="font-size: 6.5pt !important; border: 0.5px solid black; padding-left: 5pt; padding-top: 5pt; padding-bottom: 5pt;"><span style="font-weight: 500;">Card Type: </span>{{ $member->card_type }}</td>
                        @endif
                    </tr>

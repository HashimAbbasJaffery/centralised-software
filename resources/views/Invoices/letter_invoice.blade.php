    ...
    <div class="container-fluid mt-2">
        <div class="header row">
            <div class="col-9" style="vertical-align: middle;">
                <h2 style="font-size:18px; text-transform: uppercase; font-weight: 400;" class="mt-2">Introduction
                    Letter</h2>
                <p style="font-size:11px; line-height: 1px;">RII30924 | www.gwadargymkhana.com.pk - UAN:
                    +9221-111-947-111</p>
            </div>
            <div class="col-3 text-end">
                <img src="https://gwadargymkhana.com.pk/introletter/images/logo.png" alt="" class="img-fluid"
                    width="250">
            </div>
        ...
        <table class="table-bordered table mt-3" style="border: 1px solid #000 !important;">
            ...
            <tr>
                ...
                <td>Expiry Date</td>
                <td>{{ \Carbon\Carbon::parse($introletter->issue_date)->addMonths($introletter->duration->months)->format('d M Y') }}
                </td>
            </tr>

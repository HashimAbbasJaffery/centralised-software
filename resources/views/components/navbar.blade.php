...
<div class="py-4 text-gray-500 dark:text-gray-400">
    ...
    <li class="relative px-6 py-3">
      ...
      >
        <span class="inline-flex items-center">
          ...
          <span class="ml-4">Member's database</span>
        </span>
        <svg
          class="w-4 h-4"
          aria-hidden="true"
  ...
  <ul>
    <li class="relative px-6 py-3">
      ...
      >
        <span class="inline-flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" style="width: 15px;" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M463.5 224l8.5 0c13.3 0 24-10.7 24-24l0-128c0-9.7-5.8-18.5-14.8-22.2s-19.3-1.7-26.2 5.2L413.4 96.6c-87.6-86.5-228.7-86.2-315.8 1c-87.5 87.5-87.5 229.3 0 316.8s229.3 87.5 316.8 0c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0c-62.5 62.5-163.8 62.5-226.3 0s-62.5-163.8 0-226.3c62.2-62.2 162.7-62.5 225.3-1L327 183c-6.9 6.9-8.9 17.2-5.2 26.2s12.5 14.8 22.2 14.8l119.5 0z"/></svg><span class="ml-4">Recovery</span>
        </span>
        <svg
          class="w-4 h-4"
          aria-hidden="true"
      ...
      <template x-if="isRecoveryMenuOpen">
        ...
        >
          ...
          >
            <a class="w-full" href="./login.html">View Payment Schedule</a>
          </li>
          <li
            class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
          >
    ...
    <li class="relative px-6 py-3">
      ...
      >
        <span class="inline-flex items-center">
          ...
          <span class="ml-4">Membership Card</span>
        </span>
        <svg
          class="w-4 h-4"
          aria-hidden="true"
  ...
  <ul>
    <li class="relative px-6 py-3">
      ...
      >
        <span class="inline-flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" style="width: 15px;" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zm0-384c13.3 0 24 10.7 24 24l0 112c0 13.3-10.7 24-24 24s-24-10.7-24-24l0-112c0-13.3 10.7-24 24-24zM224 352a32 32 0 1 1 64 0 32 32 0 1 1 -64 0z"/></svg>     <span class="ml-4">Complains &amp; Inquiry</span>
        </span>
        <svg
          class="w-4 h-4"
          aria-hidden="true"
      ...
      <template x-if="isComplainsMenuOpen">
        ...
        >
          <li
            class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
          >
            <a class="w-full" href="./login.html">Member Complain</a>
          </li>
        </ul>
      </template>
    </li>

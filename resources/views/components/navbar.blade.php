<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0" {{ $attributes }}
    id="navbar-app">
                ...
                <ul style="height: 100%;">
                    <li class="relative px-6 py-3">
                        <button
                            ...
                            @click="togglePagesMenu" aria-haspopup="true" style="outline: none;">

                            <span class="inline-flex items-center">
                                <svg class="w-5 h-5" style="width: 15px;" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                                    <path
                            ...
                            <ul x-transition:enter="transition-all ease-in-out duration-300"
                                ...
                                <template x-if="privileges.includes('member:add')">
                                    <li
                                        ...
                                        <a class="w-full" style="font-size: 12px;"
            ...
            <template x-if="hasPrivileges('recovery')">
                <ul>
                    <li class="relative px-6 py-3">
                        <button
                            class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                            @click="toggleRecoveryMenu" aria-haspopup="true" style="outline: none;">
                            <span class="inline-flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" style="width: 15px;"
                                ...
                                </svg><span class="ml-4" style="font-size: 12px;">Recovery</span>
                            </span>
                            <svg class="w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                            ...
                            <ul x-transition:enter="transition-all ease-in-out duration-300"
                                ...
                                <template x-if="privileges.includes('recovery:payment-schedule')">
                                    <li
                                        ...
                                        <a class="w-full" href="{{ route('payment-schedule') }}"
                                            style="font-size: 12px;">View Payment Schedule</a>
                                    </li>
                                </template>
                                <template x-if="privileges.includes('recovery:report-by-members')">
                                    <li
                                        class="navbar px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                        <a class="w-full" href="{{ route('member.recovery.report') }}"
                                ...
                                <template x-if="privileges.includes('recovery:payment-receipt')">
                                    <li
                                        class="navbar px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                        <a class="w-full" href="{{ route('member.recovery.receipts.get') }}"
                                            style="font-size: 12px;">
                                ...
                                <template x-if="privileges.includes('recovery:report-overall')">
                                    <li
                                        ...
                                        <a class="navbar w-full" href="{{ route('member.recovery.overall') }}"
                                            style="font-size: 12px;">
            ...
            <template x-if="hasPrivileges('reciprocal')">
                <ul>
                    <li class="relative px-6 py-3">
                        <button
                            class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                            @click="toggleReciprocalMenu" aria-haspopup="true" style="outline: none;">
                            <span class="inline-flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" style="width: 15px;"
                                ...
                                </svg><span class="ml-4" style="font-size: 12px;">Reciprocal</span>
                            </span>
                            <svg class="w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                            ...
                            <ul x-transition:enter="transition-all ease-in-out duration-300"
                                ...
                                <template x-if="privileges.includes('reciprocal:introletters')">
                                    <li
                                        ...
                                        <a class="w-full" style="font-size: 12px;"
                                            href="{{ route('introletter.index') }}">Manage Introduction letter</a>
                                    </li>
                                </template>
                                <template x-if="privileges.includes('reciprocal:manage-club')">
                                    <li
                                        ...
                                        <a class="navbar w-full" style="font-size: 12px;"
            ...
            <template x-if="hasPrivileges('card')">
                <ul>
                    <li class="relative px-6 py-3">
                        <button
                            class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                            @click="toggleMembershipMenu" aria-haspopup="true" style="outline: none;">
                            <span class="inline-flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" style="width: 15px;"
                            ...
                            <ul x-transition:enter="transition-all ease-in-out duration-300"
                                ...
                                <template x-if="privileges.includes('card:manage')">
                                    <li
                                        ...
                                        <a class="w-full navbar" href="{{ route('card-type.index') }}"
                                            style="font-size: 12px;">
                                            Manage Card
                                        </a>
                                    </li>
                                ...
                                <template x-if="privileges.includes('card:add')">
                                    <li
                                        ...
                                        <a class="w-full navbar" href="{{ route('card-type.add') }}"
                                            style="font-size: 12px;">Add Card</a>
                                    </li>
                                </template>
                                <template x-if="privileges.includes('card:add')">
                                    <li
                                        class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->routeIs('card-type.add') ? 'text-black' : '' }}">
                                        <a class="w-full navbar" href="{{ route('membership.cards') }}"
                                            style="font-size: 12px;">Membership Cards</a>
                                    </li>
                                </template>
                            </ul>
                        </template>
            ...
            <template x-if="hasPrivileges('complains')">
                <ul>
                    <li class="relative px-6 py-3">
                        <button
                            class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                            @click="toggleComplainsMenu" aria-haspopup="true" style="outline: none;">
                            <span class="inline-flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" style="width: 15px;"
                                    viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                                    <path
                                        d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zm0-384c13.3 0 24 10.7 24 24l0 112c0 13.3-10.7 24-24 24s-24-10.7-24-24l0-112c0-13.3 10.7-24 24-24zM224 352a32 32 0 1 1 64 0 32 32 0 1 1 -64 0z" />
                                </svg> <span class="ml-4" style="font-size: 12px;">Complains &amp; Inquiry</span>
                            </span>
                            <svg class="w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                        ...
                        <template x-if="isComplainsMenuOpen">
                            <ul x-transition:enter="transition-all ease-in-out duration-300"
                                ...
                                <template x-if="privileges.includes('complains:by-member')">
                                    <li
                                        class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                        <a class="w-full" href="{{ route('complains') }}"
                                            style="font-size: 12px;">Member Complain</a>
                                    </li>
                                </template>
                                <template x-if="privileges.includes('complains:types')">
                                    <li
                                        class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                        <a class="w-full" href="{{ route('complain.complain-types.index') }}"
                                            style="font-size: 12px;">Complain Types</a>
                                    </li>
                                </template>
                            </ul>
                        </template>
                    ...
                    <li class="relative px-6 py-3">
                        <a href="{{ route('users') }}"
                            ...
                            <svg style="width: 15px;" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path
                                    d="M144 0a80 80 0 1 1 0 160A80 80 0 1 1 144 0zM512 0a80 80 0 1 1 0 160A80 80 0 1 1 512 0zM0 298.7C0 239.8 47.8 192 106.7 192l42.7 0c15.9 0 31 3.5 44.6 9.7c-1.3 7.2-1.9 14.7-1.9 22.3c0 38.2 16.8 72.5 43.3 96c-.2 0-.4 0-.7 0L21.3 320C9.6 320 0 310.4 0 298.7zM405.3 320c-.2 0-.4 0-.7 0c26.6-23.5 43.3-57.8 43.3-96c0-7.6-.7-15-1.9-22.3c13.6-6.3 28.7-9.7 44.6-9.7l42.7 0C592.2 192 640 239.8 640 298.7c0 11.8-9.6 21.3-21.3 21.3l-213.3 0zM224 224a96 96 0 1 1 192 0 96 96 0 1 1 -192 0zM128 485.3C128 411.7 187.7 352 261.3 352l117.3 0C452.3 352 512 411.7 512 485.3c0 14.7-11.9 26.7-26.7 26.7l-330.7 0c-14.7 0-26.7-11.9-26.7-26.7z" />
                            </svg> <span class="ml-4" style="font-size: 12px;">Users</span>
                        </a>
                    </li>
                </ul>
            </template>
            <template x-if="hasPrivileges('lead')">
                <ul>
                    <li class="relative px-6 py-3">
                        <a href="{{ route('leads') }}"
                            class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
    ...
    <template x-if="fetchingPrivileges" style="margin: auto;">
        <div class="py-4 text-gray-500 dark:text-gray-400 bg-gray-800"

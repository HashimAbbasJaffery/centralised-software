...
<head>
    ...
    <title>Gymkhana - Management</title>
    ...
    <link href="https://cdn.jsdelivr.net/gh/priyashpatil/phone-input-by-country@0.0.1/cpi.css" rel="stylesheet"
...
<body>
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
        ...
        <!-- Desktop sidebar -->
        <x-navbar x-show="isSideMenuOpen" style="width: 20%; width: 230px;" visible
        ...
        <x-navbar x-show="isSideMenuOpen" style="position: fixed; height: 100%; width: 230px;"
            x-transition:enter="transition ease-in-out duration-150" x-transition:enter-start="opacity-0"
            x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in-out duration-150"
            x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" />
        <!-- Mobile sidebar -->

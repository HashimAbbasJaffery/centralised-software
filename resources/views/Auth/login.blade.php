...
<head>
    ...
    <title>Login - Gymkhana Management</title>
    <link rel="icon" type="image/png" href="{{ asset('assets/img/gg_favicon.png') }}">
...
<body>
    <div class="flex items-center min-h-screen p-6 bg-gray-50 dark:bg-gray-900" id="app">
        <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800 animate__animated"
            :class="{ 'animate__shakeX': failed }">
            <div class="flex flex-col overflow-y-auto md:flex-row">

                <div class="h-32 md:h-auto md:w-1/2">
                    <img aria-hidden="true" class="object-cover w-full h-full dark:hidden"
                        src="https://gwadargymkhana.com.pk/members/interior.jpg" alt="Office" />
                ...
                <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                    <div class="w-full">
                        ...
                        <button
                            ...
                            :class="{ 'normal-state': !passed, 'passed-state': passed }" style="height: 40px;"
                            @click="generateOtp" :disabled="is_authenticating">
    ...
    const app = Vue.createApp({
        ...
        methods: {
            ...
            async generateOtp() {
                ...
                try {
                    const response = await axios.get(route("api.otp", {
            ...
            async verifyOtp(otp) {
                try {
                    const response = await axios.get(route("api.otp.verify", {
                        password: this.password,
                        user: this.username,
                        otp
                    }));

    ...
    <main id="app" class="h-full pb-16 overflow-y-auto">
        ...
        <div class="container px-6 mx-auto grid">
            ...
            <div v-show="current_step === 1"
                class="step-form px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div style="display: flex; column-gap: 20px;">
                    <div style="width: 33.33%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input v-model="member_name" data-message="member_field_message"
                            ...
                            <span style="display: none;"
                                class="member_field_message text-xs text-red-600 dark:text-red-400">
                    ...
                    <div style="width: 33.33%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input v-model="date_of_birth" data-message="date_of_birth_field_message" type="date"
                                ...
                                placeholder="shahmir ahsanullah">
                            <span style="display: none;"
                                class="date_of_birth_field_message step_1_message text-xs text-red-600 dark:text-red-400">
                    ...
                    <div style="width: 33.33%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input v-model="cnic" data-message="cnic_field_message"
                                class="step_1 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="XXXX-XXXXXXX-X">
                            <span style="display: none;"
                                class="cnic_field_message step_1_message text-xs text-red-600 dark:text-red-400">
                ...
                <div style="display: flex; column-gap: 20px;">
                    <div style="width: 50%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <select v-model="gender" data-message="gender_field_message"
                                class="step_1 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                <option value="male">Male</option>
                                <option value="female">Female</option>
                            </select>
                            <span style="display: none;"
                                class="gender_field_message step_1_message text-xs text-red-600 dark:text-red-400">
                    ...
                    <div style="width: 50%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <select v-model="marital_status" data-message="marital_field_message"
                                class="step_1 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                            ...
                            <span style="display: none;"
                                class="marital_field_message step_1_message text-xs text-red-600 dark:text-red-400">
                ...
                <div style="display: flex; justify-content: center;">
                    <div v-for="step in total_steps" class="step bg-purple-600"
                        :style="{ 'background': step <= current_step ? '' : 'gray' }"
                        style="width: 5px; height: 5px; border-radius: 100%; margin-right: 5px;">&nbsp;</div>
                </div>
            </div>
                ...
                <div style="display: flex; column-gap: 20px;">
                    <div style="width: 33.33%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input style="width: 100% !important; margin-top: 4px !important;" v-model="phone"
                                data-index="0" data-message="phone_field_message"
                                class="phone step_2 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="Phone Number">
                            <span style="display: none;"
                                class="phone_field_message text-xs text-red-600 dark:text-red-400">
                    ...
                    <div style="width: 33.33%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input v-model="alt_phone_number"
                                style="width: 100% !important; margin-top: 4px !important;" data-index="1"
                                id="alt_phone_number" data-message="alt_ph_number_field_message" type="text"
                                class="phone step_2 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="Alternate Phone Number">
                            <span style="display: none;"
                                class="alt_ph_number_field_message step_1_message text-xs text-red-600 dark:text-red-400">
                    ...
                    <div style="width: 33.33%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input v-model="email" type="email"
                                ...
                                class="step_2 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="example@example.com">
                            <span style="display: none;"
                                class="email_message step_1_message text-xs text-red-600 dark:text-red-400">
                ...
                <div style="display: flex; column-gap: 20px;">
                    <div style="width: 50%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input v-model="residential_address" type="text"
                                style="width: 100% !important; margin-top: 4px !important;"
                                data-message="residential_address_message"
                                class="step_2 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="Residential Address">
                            <span style="display: none;"
                                class="residential_address_message step_2_message text-xs text-red-600 dark:text-red-400">
                    ...
                    <div style="width: 33.33%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <v-select
                                class="step_1 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                :options="options" label="country" v-model="selectedCountry"></v-select>
                        </label>
                    </div>
                    <div style="width: 33.33%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            <span class="text-gray-700 dark:text-gray-400">Cities</span>
                            <v-select :options="paginated" label="" :filterable="false"
                                class="step_1 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                @search="onSearch" v-model="selectedCity"></v-select>
                        </label>
                    </div>
                ...
                <div style="display: flex; column-gap: 20px;">
                    <div style="width: 50%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <select v-model="membership_type" data-message="membership_type_field_message"
                                class="step_3 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                <option v-for="cardType in cardTypes" :value="cardType.id"
                                    v-text="cardType.card_name"></option>
                            </select>
                            <span style="display: none;"
                                class="membership_type_field_message step_3_message text-xs text-red-600 dark:text-red-400">
                    ...
                    <div style="width: 50%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input v-model="file_number" type="text"
                                style="width: 100% !important; margin-top: 4px !important;"
                                data-message="email_message"
                                class="step_3 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                ...
                <div style="display: flex; column-gap: 20px;">
                    <div style="width: 50%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input v-model="date_of_applying" type="date"
                                style="width: 100% !important; margin-top: 4px !important;"
                                data-message="date_of_applying_message"
                                class="step_3 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="Residential Address">
                            <span style="display: none;"
                                class="date_of_applying_message step_1_message text-xs text-red-600 dark:text-red-400">
                    ...
                    <div style="width: 50%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input v-model="membership_number" type="text"
                                style="width: 100% !important; margin-top: 4px !important;"
                                data-message="membership_number_message"
                                class="step_3 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="Membership Number">
                            <span style="display: none;"
                                class="membership_number_message step_1_message text-xs text-red-600 dark:text-red-400">
            ...
            <div v-show="current_step === 4"
                ...
                <div class="spouse" v-for="(spouse, index) in spouses" :key="spouse.id">
                    <div @click="spouse.hidden = !spouse.hidden"
                        style="margin-bottom: 20px; display: flex; justify-content: space-between;"
                        class="spouse-dropdown border border-gray-600 p-3 rounded-md dark:text-gray-200">
                        <h5 v-text="`${numberToOrdinal(index + 1)} Spouse Information`"></h5>
                        <button class="bg-red-600 text-white px-2 rounded-md"
                            @click="removeSpouse(spouse.id)">Delete</button>
                    </div>
                    <div :style="{ display: !spouse.hidden ? 'flex' : 'flex' }" style="column-gap: 20px;">
                        <div style="width: 50%;">
                            <label class="block text-sm" style="margin-bottom: 20px;">
                                <span class="text-gray-700 dark:text-gray-400"
                                    v-text="`${numberToOrdinal(index + 1)} Spouse`"></span>
                                <input v-model="spouse.name" type="text"
                                    style="width: 100% !important; margin-top: 4px !important;"
                                    data-message="email_message"
                        ...
                        <div style="width: 50%;">
                            <label class="block text-sm" style="margin-bottom: 20px;">
                                <span class="text-gray-700 dark:text-gray-400">CNIC/Passport</span>
                                <input v-model="spouse.cnic" type="text"
                                    style="width: 100% !important; margin-top: 4px !important;"
                                    data-message="email_message"
                                    class="optional step_4 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                    placeholder="CNIC">
                    ...
                    <div :style="{ display: !spouse.hidden ? 'flex' : 'flex' }" style="column-gap: 20px;">
                        ...
                        <div style="width: 25%;">
                            <label class="block text-sm" style="margin-bottom: 20px;">
                                ...
                                <input v-model="spouse.blood_group" type="text"
                                    style="width: 100% !important; margin-top: 4px !important;"
                                    data-message="email_message"
                                    class="optional step_4 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                        ...
                        <div style="width: 25%;">
                            <label class="block text-sm" style="margin-bottom: 20px;">
                                ...
                                <input style="width: 100% !important; margin-top: 4px !important;"
                                    v-model="spouse.emergency_number" :data-index="`spouse_${index}_emergency`"
                                    data-message="emergency_message"
                                    class="phone optional step_4 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                    placeholder="Contact">
                            </label>
                        </div>
                        <div style="width: 25%;">
                            <label class="block text-sm" style="margin-bottom: 20px;">
                                ...
                                <input type="file" @change="spouse.picture = $event.target.files[0]"
                                    style="width: 100% !important; margin-top: 4px !important;"
                                    data-message="email_message"
                                    class="optional step_4 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                    placeholder="Blood Group">
                ...
                <button :disabled="spouses.length > 3" @click="addSpouse"
            ...
            <div v-show="current_step === 5"
                ...
                <div v-for="(child, index) in children">
                    <div style="margin-bottom: 20px; display: flex; justify-content: space-between;"
                        class="children-dropdown border border-gray-600 p-3 rounded-md dark:text-gray-200">
                        <h5 @click="children.hidden = !children.hidden"
                            v-text="`${numberToOrdinal(index + 1)} Child Information`"></h5>
                        <button class="bg-red-600 text-white px-2 rounded-md"
                            @click="removeChild(child.id)">Delete</button>
                    </div>
                    <div style="width: 100%; display: flex; column-gap: 10px;">
                        <div style="width: 50%;">
                            <label class="block text-sm" style="margin-bottom: 20px;">
                                <span class="text-gray-700 dark:text-gray-400" style="text-transform: capitalize;"
                                    v-text="`${numberToOrdinal(index + 1)} child`"></span>
                                <input v-model="child.childName" type="text"
                                    style="width: 100% !important; margin-top: 4px !important;"
                                    data-message="email_message"
                                    class="optional step_5 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                    :placeholder="`${numberToOrdinal(child.id)} child`">
                            </label>
                        </div>
                        <div style="width: 50%;">
                            <label class="block text-sm" style="margin-bottom: 20px;">
                                <span class="text-gray-700 dark:text-gray-400"
                                    style="text-transform: capitalize;">CNIC/Passport</span>
                                <input v-model="child.cnic" type="text"
                                    style="width: 100% !important; margin-top: 4px !important;"
                                    data-message="email_message"
                                    class="optional step_5 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                    ...
                    <div style="width: 100%; display: flex; column-gap: 10px;">
                        ...
                        <div style="width: 50%;">
                            <label class="block text-sm" style="margin-bottom: 20px;">
                                <span class="text-gray-700 dark:text-gray-400"
                                    style="text-transform: capitalize;">Date of Issue</span>
                    ...
                    <div style="width: 100%; display: flex; column-gap: 10px;">
                        <div style="width: 20%;">
                            <label class="block text-sm" style="margin-bottom: 20px;">
                                <span class="text-gray-700 dark:text-gray-400" style="text-transform: capitalize;"
                                    v-text="`Validity`"></span>
                                <input v-model="child.validity" type="date"
                                    style="width: 100% !important; margin-top: 4px !important;"
                                    data-message="email_message"
                                    class="optional step_5 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                    :placeholder="`Validity`">
                        ...
                        <div style="width: 20%;">
                            <label class="block text-sm" style="margin-bottom: 20px;">
                                <span class="text-gray-700 dark:text-gray-400"
                                    style="text-transform: capitalize;">Membership Type</span>
                                <select v-model="child.child_card" data-message="membership_type_field_message"
                                    class="step_3 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                    <option :value="card.id" v-for="card in child_memberships"
                                        v-text="card.card_name"></option>
                                </select>
                            </label>
                        </div>
                        <div style="width: 20%;">
                            <label class="block text-sm" style="margin-bottom: 20px;">
                                <span class="text-gray-700 dark:text-gray-400"
                                    style="text-transform: capitalize;">Blood Group</span>
                                <input v-model="child.blood_group" type="text"
                                    style="width: 100% !important; margin-top: 4px !important;"
                                    data-message="email_message"
                                    class="optional step_5 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                    :placeholder="`Blood Group`">
                        ...
                        <div style="width: 20%;">
                            <label class="block text-sm" style="margin-bottom: 20px;">
                                ...
                                <input style="width: 100% !important; margin-top: 4px !important;"
                                    v-model="child.emergency_number" :data-index="`child_${index}_emergency`"
                                    data-message="emergency_message"
                                    class="phone optional step_5 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                    placeholder="Contact">
                            </label>
                        </div>
                        <div style="width: 20%;">
                            <label class="block text-sm" style="margin-bottom: 20px;">
                                <span class="text-gray-700 dark:text-gray-400"
                                    style="text-transform: capitalize;">Picture</span>
                                <input type="file" @change="child.profile_pic = $event.target.files[0]"
                                    style="width: 100% !important; margin-top: 4px !important;"
                                    data-message="email_message"
                                    class="optional step_5 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                    :placeholder="`Date of Issue`">
                ...
                <div class="actions">
                    <button @click="addNewChild" class="bg-purple-600 text-white p-1 px-2 rounded-md">Add new
                        Child</button>
                </div>
                <div style="display: flex; justify-content: center;">
                    <div v-for="step in total_steps" class="step bg-purple-600"
                ...
                <div style="display: flex; column-gap: 20px;">
                    <div style="width: 25%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <select v-model="payment_status" data-message="membership_type_field_message"
                                class="step_3 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                    ...
                    <div style="width: 25%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input type="text" :value="Number(form_fee).toLocaleString('en-US')"
                                @input="form_fee = $event.target.value.replace(/,/g, '')" placeholder="Form Fee"
                                style="width: 100% !important; margin-top: 4px !important;"
                                class="optional step_4 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" />
                        </label>
                    </div>
                    <div style="width: 25%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input type="text" :value="Number(processing_fee).toLocaleString('en-US')"
                    ...
                    <div style="width: 25%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input type="text" :value="Number(first_payment).toLocaleString('en-US')"
                ...
                <div style="display: flex; column-gap: 20px;">
                    <div style="width: 33.33%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input type="text" :value="Number(total_installment).toLocaleString('en-US')"
                    ...
                    <div style="width: 33.33%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input type="text" v-model="installment_month"
                                style="width: 100% !important; margin-top: 4px !important;"
                                data-message="email_message"
                                class="optional step_4 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
            ...
            <div v-show="current_step === 7"
                ...
                <div style="display: flex; column-gap: 20px;">
                    <div style="width: 33.33%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input v-model="company_name" type="text" placeholder="e.g Visionary Group"
                    ...
                    <div style="width: 33.33%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input v-model="company_designation" type="text" placeholder="e.g COO"
                                style="width: 100% !important; margin-top: 4px !important;"
                ...
                <div style="column-gap: 20px;"
                    :style="{ display: parseInt(membership_with_extra_details) === parseInt(membership_type) ? 'flex' : 'none' }">
                    <div style="width: 33.33%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            <span class="text-gray-700 dark:text-gray-400" style="margin-bottom: 20px;">Office Phone
                                Number</span>
                            <br>
                            <input type="hidden" v-model="phone_numbers[2].countryCode" />
                            <input type="hidden" v-model="phone_numbers[2].phoneNumber" />
                            <input style="width: 100% !important; margin-top: 4px !important;"
                                v-model="office_ph_number" data-index="3" data-message="phone_field_message"
                                class="optional phone step_2 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="Phone Number">
                            <span style="display: none;"
                                class="phone_field_message text-xs text-red-600 dark:text-red-400">
                                Phone number field is required
                    ...
                    <div style="width: 33.33%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input type="text" v-model="office_country"
                                style="width: 100% !important; margin-top: 4px !important;"
                                data-message="email_message"
                                class="optional step_4 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="Country">
                    ...
                    <div style="width: 33.33%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input type="text" v-model="office_city"
                                style="width: 100% !important; margin-top: 4px !important;"
                                data-message="email_message"
                                class="optional step_4 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="City">
                ...
                <div style="column-gap: 20px;"
                    ...
                    <div style="width: 50%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input type="text" v-model="work_email"
                                style="width: 100% !important; margin-top: 4px !important;"
                                data-message="email_message"
                                class="optional step_4 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="Country">
                    ...
                    <div style="width: 50%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input type="text" v-model="office_address"
                                style="width: 100% !important; margin-top: 4px !important;"
                                data-message="email_message"
                                class="optional step_4 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="City">
            ...
            <div v-show="current_step === 8"
                ...
                <div style="display: flex; column-gap: 20px;">
                    <label class="block text-sm" style="margin-bottom: 20px; width: 50%">
                        <span class="text-gray-700 dark:text-gray-400">Blood Group</span>
                        <select v-model="blood_group" data-message="marital_field_message"
                            class="step_1 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                            <option value="-">-</option>
                    ...
                    <div style="width: 50%;">
                        <label class="block text-sm">
                            ...
                            <input type="text" v-model="emergency_contact" data-index="2"
                                style="width: 100% !important; margin-top: 4px !important;"
                                data-message="emergency_contact"
                                class="optional phone step_7 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
            ...
            <div v-show="current_step === 9"
                ...
                <div style="display: flex; column-gap: 20px;">
                    <div style="width: 50%;">
                        <label class="block text-sm">
                            ...
                            <input type="file" @change="profile_picture = $event.target.files[0]"
                                style="width: 100% !important; margin-top: 4px !important;"
                                data-message="email_message"
                                class="optional step_4 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="Profile Picture">
                        </label>
                        <p class="text-primary" style="margin-bottom: 20px; color: #0d6efd; font-size: 13px;">Expected
                            aspect ratio 4/5</p>
                    </div>
                    <label class="block text-sm" style="margin-bottom: 20px; width: 50%">
                        <span class="text-gray-700 dark:text-gray-400">Card Type</span>
                        <select v-model="card_type" data-message="marital_field_message"
                            class="step_8 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                ...
                <div style="display: flex; column-gap: 20px;">
                    <div style="width: 50%;">
                        <label class="block text-sm">
                            <span class="text-gray-700 dark:text-gray-400">Date of Issue</span>
                            <input type="date" v-model="date_of_issue"
                                style="width: 100% !important; margin-top: 4px !important;"
                                data-message="date_of_issue"
                                class="step_8 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="Profile Picture">
                        </label>
                    ...
                    <div style="width: 50%;">
                        <label class="block text-sm">
                            <span class="text-gray-700 dark:text-gray-400">Validity</span>
                            <input type="date" v-model="validity"
                                style="width: 100% !important; margin-top: 4px !important;"
                                data-message="validity_message"
                                class="step_8 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                placeholder="Profile Picture">
                        </label>
                ...
                <div style="display: flex; column-gap: 20px;">
                    <div style="width: 50%;">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <select v-model="locker_category" data-message="marital_field_message"
                                class="step_1 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                <option value="a">A</option>
                                <option value="b">B</option>
                    ...
                    <label class="block text-sm" style="margin-bottom: 20px; width: 50%">
                        <label class="block text-sm" style="margin-bottom: 20px;">
                            ...
                            <input type="text" v-model="locker_number"
                                style="width: 100% !important; margin-top: 4px !important;"
                                data-message="email_message"
                                class="optional step_4 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
            ...
            {{-- <div class="flex items-center justify-between w-full">
                <div class="steps flex-1 flex justify-center">
                    <ol class="items-center w-full space-y-4 sm:flex sm:space-x-8 sm:space-y-0 rtl:space-x-reverse"
                        ...
                        <li>
                            <button @click="previous" :disabled="current_step == 1" style="background: #1f2937;"
                                class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-700 border border-transparent rounded-lg active:bg-gray-600 hover:bg-gray-700 focus:outline-none focus:shadow-outline-gray">
                                Previous
                            </button>
                        </li>
    ...
    <script>
        ...
        new Vue({
            ...
            data: {
                ...
                phone_numbers: [{
                        countryCode: "{{ $member->phone_number_code }}",
                        phoneNumber: "{{ str_replace('+', '', $member->phone_number) }}"
                    },
                    {
                        countryCode: "{{ $member->alternate_ph_number_code }}",
                        phoneNumber: "{{ str_replace('+', '', $member->alternate_ph_number) }}"
                    },
                    {
                        countryCode: "{{ $member->emergency_contact_code }}",
                        phoneNumber: "{{ str_replace('+', '', $member->emergency_contact) }}"
                    },
                    {
                        countryCode: "92",
                        phoneNumber: "{{ str_replace('+', '', $member->profession?->office_phone_number ?? null) }}"
                    },
                ],
            ...
            computed: {
                ...
                totalSum() {
                    ...
                    if (this.form_fee && typeof parseInt(this.form_fee) === "number") total += parseInt(this
                        .form_fee);
                    if (this.processing_fee && typeof parseInt(this.processing_fee) === "number") total += parseInt(
                        this.processing_fee);
                    if (this.first_payment && typeof parseInt(this.first_payment) === "number") total += parseInt(
                        this.first_payment);
                    if (this.total_installment && typeof parseInt(this.total_installment) === "number") total +=
                        parseInt(this.total_installment);
            ...
            methods: {
                ...
                getData() {
                    ...
                    this.spouses.forEach((spouse, index) => {
                        ...
                        fd.append(`spouses[${index}][emergency_country_code]`, spouse
                            .emergency_country_code);
                        fd.append(`spouses[${index}][emergency_phone_number]`, spouse
                            .emergency_phone_number);
                    ...
                    this.children.forEach((child, index) => {
                        ...
                        fd.append(`children[${index}][emergency_country_code]`, child
                            .emergency_country_code);
                        fd.append(`children[${index}][emergency_phone_number]`, child
                            .emergency_phone_number);
                ...
                async submit() {
                    ...
                    try {
                        const response = await axios.post(route("api.member.update", route().params), this
                            .formData, {
                                headers: {
            ...
            async mounted() {
                ...
                this.membership_with_extra_details = this.cardTypes.find(ct => ct.card_name.toLowerCase() ===
                    'corporate')?.id ?? null;

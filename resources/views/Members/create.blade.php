          ...
          const app = Vue.createApp({
            ...
            removeChild(id) {
              ...
              getData() {
                  ...
                  this.formData.append("marital_status", this.marital_status);
                  this.formData.append("cnic_passport", this.cnic);
                  this.formData.append("phone_number", this.phone);
                  this.formData.append("alternate_ph_number", this.alt_phone_number);
                  this.formData.append("email_address", this.email);
                  this.formData.append("residential_address", this.residential_address);
                  this.formData.append("city_country", this.city_country);
                  this.formData.append("membership_type", this.membership_type);
                  this.formData.append("membership_number", this.membership_number);
                  this.formData.append("membership_status", this.membership_status);
                  this.formData.append("file_number", this.file_number);
                  this.formData.append("date_of_applying", this.date_of_applying);
                  this.formData.append("form_fee", this.form_fee);
                  this.formData.append("processing_fee", this.processing_fee);
                  this.formData.append("first_payment", this.first_payment);
                  this.formData.append("total_installment", this.total_installment);
                  this.formData.append("installment_month", this.installment_month);
                  this.formData.append("blood_group", this.blood_group);
                  this.formData.append("emergency_contact", this.emergency_contact);
                  this.formData.append("profile_picture", this.profilePictureBase64); // If base64, append as string
                  this.formData.append("card_type", this.card_type);
                  this.formData.append("date_of_issue", this.date_of_issue);
                  this.formData.append("validity", this.validity);
                  this.formData.append("spouses", this.spouses);
